function sumar(a, b) {
    console.log(a + b); // a y b son parámetros de la función
}

sumar(2, 3); // 2 y 3 son argumentos de la función (se pasan por valor)
sumar(200, 184); // 200 y 184 son argumentos de la función (se pasan por valor
